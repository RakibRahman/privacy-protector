        ...
        <Flex flexDirection="column" gridGap="8" fontSize="22" color="white">
          ...
          <Flex flexDirection="column" gridGap="6">
            ...
            <Text>
              ...
              <br />
              <br />
              “Most people put capital letters at the beginning and digits and
              symbols at the end. If you do that, you get very little benefit
              from adding these special characters.”
            </Text>
          </Flex>
          <Flex flexDirection="column" gridGap="6">
          ...
          <Flex gridGap="6" flexDirection="column">
            ...
            <Text>
              ...
              <br />
              <br />
              "For your web passwords you mostly have to worry about
              withstanding a few thousand guesses." Yes, that's still a lot of
              guesses. But if anything, it's a reminder that if you do commit to
              password best practices, the bad guys are probably going to move
              right along.
            </Text>
          </Flex>
          <Flex flexDirection="column" gridGap="6">
            ...
            <Text>
              ...
              than the lowest-risk applications.” Adding a layer of protection
              makes sense, but it also has potential ancillary benefits that
              ...
              Product Management for Dell Security Which, hey! As great as an
              airtight password is, anything that makes them a little easier to
              achieve is more than welcome.{" "}
            </Text>
          </Flex>
          <Link
            to={{
