...
export const Tips = () => {
  ...
  return (
    <Box w="80%" mx="auto" p="4" className="tips">
      ...
      />
      <VStack my="10" fontSize="19" spacing="25px">
        <Text>
      ...
      <Flex flexDirection="column" gridGap="8" fontSize="22">
        ...
        <Flex flexDirection="column" gridGap="6">
          ...
          <Text>
            ...
            Longer is always better, but that length yields diminishing returns
            if you’re not still mixing it up.
          </Text>
          <Text>
            “We have seen an effort by many people to be more secure by adding
            characters to passwords, but if these longer passwords are based on
            simple patterns they will put you in just as much risk of having
            your identity stolen by hackers,” says Morgan Slain, CEO of
          ...
          <Text>
            ...
            year---regardless of length. The more common a password is, the less
            secure it will be, so go with something no one else would (ideally,
            a random string).
          </Text>
        </Flex>
        ...
        <Flex flexDirection="column" gridGap="6">
          ...
          <Text>
            “Put your digits, symbols, and capital letters spread throughout the
            middle of your password, not at the beginning or end,” says Lorrie
            Faith Cranor, FTC Chief Technologist and Carnegie Mellon computer
            science professor. “Most people put capital letters at the beginning
            and digits and symbols at the end. If you do that, you get very
            little benefit from adding these special characters.”
          </Text>
        </Flex>
        <Flex flexDirection="column" gridGap="6">
          ...
          <Text>
            ...
            It would take years for someone to crack. Your password is so good,
            in fact, and took so long to memorize, that you’ve decided to use it
          ...
          <Text>
            ...
            hacker to attack one site and get your password to all the others.”
            <Text>
              ...
              fallout by using a unique password everywhere. Or, you know, skip
              the whole thing and use a password manager.
            </Text>
          </Text>
        </Flex>
        <Flex flexDirection="column" gridGap="6">
          ...
          <Text>
            We’ve touched on this before, but it’s counterintuitive enough that
            it bears repeating: Don’t change passwords every month. And if
            you’re an IT admin, don’t force your employees to.
          </Text>
          <Text>
        ...
        <Flex gridGap="6" flexDirection="column">
          ...
          <Text>
            You're right to do everything you can to make your password as safe
            as possible. But it might also help to remember that most people
            don't need a digital Fort Knox. A digital combination lock should do
            just fine.
          </Text>
          <Text>
          ...
          <Text>
            Yes, that's still a lot of guesses. But if anything, it's a reminder
            that if you do commit to password best practices, the bad guys are
            probably going to move right along.
          </Text>
        </Flex>
        <Flex flexDirection="column" gridGap="6">
          ...
          <Text>
            “Don’t rely on passwords alone!” says Neil Wynne, a senior research
            analyst at Gartner who focuses on business security. “Passwords
            should not be considered sufficient for anything other than the
            lowest-risk applications.”
          </Text>
          <Text>
            Adding a layer of protection makes sense, but it also has potential
            ancillary benefits that aren’t quite so obvious.
          </Text>
          <Text>
          ...
          <Text>
            Which, hey! As great as an airtight password is, anything that makes
            them a little easier to achieve is more than welcome.{" "}
          </Text>
        </Flex>
        <Link
          mt="30"
